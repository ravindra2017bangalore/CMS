...
<%  
List<ComplainGetSet> list=ComplaintDao.getAllRecordsforStd();  
request.setAttribute("list",list);  
%>  

<table class="table" border="1">
<thead>  
<tr><th>Complaint Id</th><th>Complaint Type</th><th>Name</th><th>Branch</th><th>Mobile</th>  
<th>Full View Complaint</th><th>Delete</th><th>Allot</th></tr></thead>  
<c:forEach items="${list}" var="u">  
<tr class="active"><td>${u.getComplaintId()}</td><td>${u.getComplaintType()}</td><td>${u.getName()}</td> <td>${u.getBranch()}</td> 
<td>${u.getMobile()}</td>
